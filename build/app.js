...
var SET_SAY = 'SET_SAY';
var FETCH_SUCCESSED = 'FETCH_SUCCESSED';
...
function appMiddleware() {
  return function (next) {
    return function (action) {
      ...
      var _types = slicedToArray(types, 2),
          success = _types[0],
          failure = _types[1];
      ...
      return fetch(fetchAPI.path, fetchSetting).then(function (response) {
...
var fetchSuccessed = function fetchSuccessed(json) {
  return {
...
var fetchFailed = function fetchFailed() {
  return {
    type: FETCH_FAILED
  };
};

var setSay = function setSay(say) {
  return {
    type: SET_SAY,
    say: say
  };
...
var Hello = function (_Component) {
  inherits(Hello, _Component);

  function Hello() {
    classCallCheck(this, Hello);

    var _this = possibleConstructorReturn(this, (Hello.__proto__ || Object.getPrototypeOf(Hello)).call(this));

    Object.defineProperty(_this, '_onClickHandler', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.props.setSay('React Redux Cool!');
      }
    });
    Object.defineProperty(_this, '_onFetchHandler', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.props.fetchAPI();
      }
    });
    return _this;
  }
  ...
  createClass(Hello, [{
    ...
    value: function render() {
      return [react.createElement(
        ...
        react.createElement(
          'button',
          { type: 'button', onClick: this._onClickHandler },
          'Click Me!'
        )
      ), react.createElement(
        'div',
        ...
        react.createElement(
          'button',
          { type: 'button', onClick: this._onFetchHandler },
          'fetchAPI!'
        ),
        'github:',
...
var Hello$1 = connect(function (state) {
  return {
    say: state.hello.say,
...
var Root = function (_Component) {
  ...
  function Root() {
    ...
    return possibleConstructorReturn(this, (Root.__proto__ || Object.getPrototypeOf(Root)).call(this));
  }

  createClass(Root, [{
    key: 'render',
    value: function render() {
      return react.createElement(Hello$1, null);
    }
  }]);
  return Root;
}(react_2);
...
var finalCreateStore = compose(applyMiddleware(appMiddleware), window.devToolsExtension ? window.devToolsExtension() : function (f) {
  return f;
})(createStore);
